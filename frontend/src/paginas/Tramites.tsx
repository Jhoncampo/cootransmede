    ...
    return (
        <>
            ...
            <SeccionInformacion
                ...
                descripcion={[
                    `Satisfacer las necesidades de los asociados, maximizando el valor agregado de los empleados para que a través de ellos, se logre un balance social rico en capacitación permanente, participación democrática, efectiva en los órganos de administración y beneficio para él, ellos y su núcleo familiar, con base en los principios cooperativos vigentes.`,
                ]}
            />
            <SeccionInformacion
            ...
            <SeccionInformacion
                ...
                descripcion={[
                    `La actividad principal es coordinar la prestación del servicio de transporte público de taxis; comercializar los productos y servicios requeridos por la industria del transporte como equipos, repuestos, insumos, servicio de taller para mantenimiento y reparación y las demás actividades necesarias para el cumplimiento de sus objetivos.`,
                ]}
            />
            <SeccionInformacion
